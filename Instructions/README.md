...
Inspect the CSVs and sketch out an ERD of the tables. Feel free to use a tool like [http://wwwpost.quickdatabasediagrams.com](http://www.quickdatabasediagrams.com).
